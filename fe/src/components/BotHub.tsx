      ...
      <div style={st("position:sticky;top:0;z-index:50;backdrop-filter:blur(10px);background:rgba(13,13,15,0.82);border-bottom:1px solid #2A2A30;")}>
        <div style={st("max-width:1180px;margin:0 auto;padding:0 32px;height:58px;display:flex;align-items:center;justify-content:space-between;")}>
          ...
          <div style={st("display:flex;align-items:center;gap:26px;font-size:13px;color:#86868E;")}>
            ...
            <Hover as="a" href="#try" style={st("text-decoration:none;color:#0D0D0F;background:#B5A8FF;font-weight:700;padding:7px 15px;font-size:13px;")} hover={st("background:#8B7FD9;")}>try it</Hover>
          </div>
        </div>
      </div>
      ...
      <div id="pricing" style={st("max-width:1180px;margin:0 auto;padding:104px 32px 0;")}>
        <div style={st("display:grid;grid-template-columns:84px 1fr;")}>
          ...
          <div style={st("border-left:1px solid #2A2A30;padding-left:40px;")}>
            ...
            <div style={st("display:grid;grid-template-columns:repeat(3,1fr);gap:16px;align-items:start;")}>
              {v.tiers.map((t, i) => (
      ...
      <div style={st("max-width:1180px;margin:0 auto;padding:104px 32px 0;")}>
        <div style={st("display:grid;grid-template-columns:84px 1fr;")}>
          ...
          <div style={st("border-left:1px solid #2A2A30;padding-left:40px;")}>
            ...
            <div style={st("display:grid;grid-template-columns:repeat(3,1fr);gap:16px;")}>
              <div style={st("border:1px solid #2A2A30;background:#0A0A0C;padding:22px;")}>
                <div style={st("display:flex;align-items:center;gap:14px;margin-bottom:16px;")}>
                  ...
                  <div>
                    <div style={st("font-size:14px;font-weight:700;color:#FFFFFF;")}>Founder One</div>
                    <div style={st("font-size:11.5px;color:#B5A8FF;margin-top:3px;")}>runtime</div>
                  </div>
                </div>
              ...
              <div style={st("border:1px solid #2A2A30;background:#0A0A0C;padding:22px;")}>
                <div style={st("display:flex;align-items:center;gap:14px;margin-bottom:16px;")}>
                  <ImageSlot style={st("width:54px;height:54px;display:block;flex:none;border:1px solid #2A2A30;")} placeholder="photo" />
                  <div>
                    <div style={st("font-size:14px;font-weight:700;color:#FFFFFF;")}>Founder Two</div>
                    <div style={st("font-size:11.5px;color:#86868E;margin-top:3px;")}>infra</div>
                  </div>
                </div>
              ...
              <div style={st("border:1px solid #2A2A30;background:#0A0A0C;padding:22px;")}>
                <div style={st("display:flex;align-items:center;gap:14px;margin-bottom:16px;")}>
                  <ImageSlot style={st("width:54px;height:54px;display:block;flex:none;border:1px solid #2A2A30;")} placeholder="photo" />
                  <div>
                    <div style={st("font-size:14px;font-weight:700;color:#FFFFFF;")}>Founder Three</div>
                    <div style={st("font-size:11.5px;color:#86868E;margin-top:3px;")}>dx</div>
                  </div>
                </div>
